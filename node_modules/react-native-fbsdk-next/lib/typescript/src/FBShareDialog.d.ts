...
export declare type ShareDialogMode = ShareDialogModeIOS | ShareDialogModeAndroid;
export declare type ShareDialogModeAndroid = 
/**
 ...
 */
 | 'feed';
export declare type ShareDialogModeIOS = 'automatic' | 'browser' | 'webview'
/**
 * The native dialog is used.
 */
 | 'native';
export declare type ShareDialogResult = RNFBSDKCallback & {
    postId: string;
};
